...
class SiddhantLogin extends Template implements ActionListener, Runnable
{
    JButton SUBMIT;
    ...
    SiddhantLogin()
    {
        ...
        TopLabel.setBounds(10,40, topsize.width + 50, topsize.height + 50);
        TopLabel.setFont(new Font("Times",Font.BOLD,15));
        ...
        SUBMIT.setBounds(150,220,ssize.width + 5,ssize.height);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource() == SUBMIT)
        {
            if(Validate(value1,value2) == false)
            {
                text1.setText("");
                text2.setText("");
                JOptionPane.showMessageDialog(this, "Short username","Siddhant's Packer Unpacker",JOptionPane.ERROR_MESSAGE);
            }
            if(value1.equals("Siddhant") && value2.equals("Siddhant"))
            {
                NextPage page = new NextPage("Siddhant Desale");
                this.setVisible(false);
                page.pack();
            ...
            else
            {
                ...
                if(attemp == 0)
                {
                    JOptionPane.showMessageDialog(this,"Number of attempts finished","Siddhant's Packer Unpacker",JOptionPane.ERROR_MESSAGE);
                    this.dispose();
                    System.exit(0);
                }
...
class SiddhantMain
{
    public static void main(String arg[])
    {
        try
        {
            SiddhantLogin frame = new SiddhantLogin();
